...
## 2026-02-12 - Exposing Keyboard Shortcuts

**Learning:** Adding visible keyboard shortcut hints to tooltips and aria-labels significantly improves discoverability for power users without cluttering the UI.
**Action:** When adding keyboard shortcuts, always update the associated UI element's tooltip and aria-label to reflect the shortcut.
